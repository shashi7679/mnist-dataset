...
for i in range(len(resize_images_size)):
    ...
    model = svm.SVC(gamma = hyperparameter_values)
    ...
    print("\t\t ",resize_images_size[i] ,"\t\tValidation Set","\t\t",hyperparameter_values,"\t\t",acc_val*100)
    print("\t\t ",resize_images_size[i] ,"\t\tTest Set","\t\t",hyperparameter_values,"\t\t",acc_test*100)
